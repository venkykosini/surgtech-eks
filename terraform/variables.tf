...
variable "codestar_connection_arn" {
  ...
  validation {
    condition     = var.enable_cicd == false || trimspace(var.codestar_connection_arn) != ""
    error_message = "Set codestar_connection_arn when enable_cicd is true."
  }
}

variable "enable_cicd" {
  description = "Whether to create CodeBuild and CodePipeline resources."
  type        = bool
  default     = false
}
